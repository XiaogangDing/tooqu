...
$.fn.KinSlideshow = function(settings){
	 ...
	 function KinSlideshow_setBtn(){
		 ...
		 if(settings.isHasBtn && KinSlideshow_imgaeLength >= 2){
			 ...
			 $(KinSlideshow_BoxObjectSelector+" .KinSlideshow_btnBox #btnlistID li").css({listStyle:"none",float:"left",width:14,height:14,'overflow':'hidden',borderWidth:settings.btn.btn_borderWidth,borderColor:settings.btn.btn_borderColor,borderStyle:"solid",background:settings.btn.btn_bgColor,textAlign:"center",cursor:"pointer",marginLeft:3,fontSize:10,fontFamily:settings.btn.btn_fontFamily,lineHeight:"14px",opacity:settings.btn.btn_bgAlpha,color:settings.btn.btn_fontColor});
	...
	function KinSlideshow_mousehover(){   // 设置自动播放
			$("#btnlistID li").mouseover(function(){
